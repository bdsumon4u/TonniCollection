...
class OrderService
{
    ...
    private function extractAddress($data)
    {
        return [
            ...
            'zip' => data_get($data, 'country', 'Bangladesh'),
        ];
    }
    ...
    private function store($request)
    {
        return Order::create([
            ...
            'billing_city' => data_get($request->billing, 'city', ' '),
            'billing_state' => data_get($request->billing, 'state', ' '),
            'billing_zip' => data_get($request->billing, 'zip', ' '),
            'billing_country' => data_get($request->billing, 'country', 'Bangladesh'),
            ...
            'shipping_city' => data_get($request->shipping, 'city', ' '),
            'shipping_state' => data_get($request->shipping, 'state', ' '),
            'shipping_zip' => data_get($request->shipping, 'zip', ' '),
            'shipping_country' => data_get($request->shipping, 'Country', 'Bangladesh'),
